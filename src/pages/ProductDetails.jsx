            ...
            <div className="p-4 mt-16 text-white lg:max-w-7xl max-w-xl max-lg:mx-auto">
                <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-2">
                        <h2 className="text-2xl font-bold text-white">Espresso Elegante | Coffee</h2>
                        <div className="flex flex-wrap gap-4 mt-4">
                            <p className="text-white text-xl font-bold">$12</p>
                            <p className="text-white text-xl"><strike>$16</strike> <span className="text-sm ml-1">Tax included</span></p>
                        </div>
                        ...
                        <div className="mt-8">
                            <h3 className="text-xl font-bold text-white">About the coffee</h3>
                        ...
                        <div className="mt-8">
                            <h3 className="text-xl font-bold text-white">Reviews(10)</h3>
