      ...
      <div class="md:w-2/3 w-full px-4 text-white flex flex-col">
        ...
        <div class="flex mt-8 flex-col items-center gap-4  ">
          ...
          <div class="w-44 pt-6 md:pt-0">
            <a
              href="mailto:bayanbaghdadi@gmail.com"
              class="bg-red-500 justify-center text-center rounded-lg shadow px-4 py-2 flex items-center"
            >
              Let's get in touch
            </a>
          </div>
